...
addPlot()
addSignal('HYQ_GRFSUM', msg.utime,msg.pos[0])
addSignal('HYQ_GRFSUM', msg.utime,msg.pos[1])
addSignal('HYQ_GRFSUM', msg.utime,msg.pos[2])

addSignal('HYQ_GRFSUM', msg.utime,msg.vel[0])
addSignal('HYQ_GRFSUM', msg.utime,msg.vel[1])
addSignal('HYQ_GRFSUM', msg.utime,msg.vel[2])

addSignal('HYQ_GRFSUM',msg.utime,msg.accel[0])
addSignal('HYQ_GRFSUM',msg.utime,msg.accel[1])

#addSignals('HYQ_GRFSUM',msg.utime,msg.vel,[0,1,2])

addPlot()
addSignals('POSE_GROUND_TRUTH',msg.utime,msg.vel,[0,1,2])
addSignals('POSE_RAW_KIN',msg.utime,msg.vel,[0,1,2])
addSignals('POSE_BODY',msg.utime,msg.vel,[0,1,2])
